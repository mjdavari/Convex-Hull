...
Proof.
intros. apply andb_true_iff in H. tauto.
Qed.
...
Proof. intros.
simpl in *. unfold ble_nat in *. induction n.
- discriminate.
- fold ble_nat in *. induction m.
  + simpl in *. lia.
  + 
admit.
...
Proof.
 ...
 admit. (* apply not_eq_beq_false. assumption.  Qed.*)
